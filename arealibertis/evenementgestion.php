...
<!-- Fin menu -->
															...
															if ( in_array($extension_upload,$extensions_valides) )
															{
																...
																if($result==TRUE)
																{
																	...
																	{	
																		...
																		?>
																		<div class="STA-succes">Evenement -  Soirée bien enrégistré(e)</div>
																		   <?php
 ...
 <input type="reset" value="Annuler" />
     <br/><br/>
              ...
              <p>
														<label style="font-weight:bold;" for="MAX_FILE_SIZE" class="form_col">Vignettes : </label>
    ...
    <div id="scrolltable">
     <table  style="width: 50%; float:right;" class="latable">
													<tr>
														<th colspan="5" style="font-size:24px;font-weight:normal;">Liste des Evenements / Soirées</th>
													</tr>
                  ...
                  while($donnees = $req->fetch())
													...
													<tr>
														<td style="width: 20%;padding:0px 15px; height:150px">
															...
															?>
															<p>
																<img src="../images/imgesevenement/<?php echo $donnees["image_evenement"];?>" style="max-width:70px;max-height:100px;border-radius:60px;" />
															</p>
															<?php
															}
															?>
                                                        ...
                                                        <td style="width: 30%;padding:0px 15px;">
															<form method="post" action="publicationevenement.php">
                                                            
                                                            <p>	
                                                                <br/><br/><br/>
                                                                
                                                                <input  type="hidden" name="dateevenement" value="<?php echo $donnees["date_evenement"]; ?>" width="50" />
                                                                
                                                                <input onclick="#" type="submit" name="addartpanier" value="Publier" width="50" />
                                                                </p>
                                                            </form>
