                    ...
                    <div class="STA-content-layout-row">
                        ...
                        <div class="STA-layout-cell STA-content">
							<article class="STA-post STA-article">
									<h2 class="STA-postheader">Messages reçus</h2>
								...
								?>
										...
										<div class="STA-smstext">
											<?php 
												...
												$req = $bdd->query('SELECT COUNT(titremessage) AS nbremessages FROM messages WHERE destinatairemessage = "LIBERTIS CLUB" AND naturemessage = "non lu" AND statutdestinactifs = "actif" ');
												$donnees = $req->fetch();
												...
												$req->closeCursor();
											?>
											<br /><p style="font-size:45px;color:#ED1E02;"><?php echo $nbremessages; ?>
											
											<a href="messagerecu.php" style="color:#ED1E02;font-size:20px;text-decoration:none;">Message(s) non lus </a></p>
										</div>
										<br />
										<!-- Recherche -->
											...
											<tr>
												<td style="border:0px solid gray;">
													<form style="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
														<input type="text" name="searchmembre" style="font-style:italic;" size="45" placeholder="Recherchez un expéditeur" /> <br /><br /><input type="submit" name="search" value="OK" class="STA-button" />
													</form>
												</td>
												<td style="border:0px solid gray;">										
													<form style="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
										...
										<!-- Fin Recherche -->
													...
													<table style="width: 100%; font-size:13px;">
														...
														<?php 
																...
																$req = $bdd->query('SELECT idmessages,titremessage,naturemessage,destinatairemessage,expediteurmessage,DATE_FORMAT(datemessages, "%d/%m/%Y à %Hh%imin") AS datemessagesfr FROM messages WHERE destinatairemessage = "LIBERTIS CLUB" AND statutdestinactifs = "actif" ORDER BY idmessages DESC ');
																while($donnees = $req->fetch())
																{
