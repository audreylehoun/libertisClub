...
<!-- Fin menu -->
    ...
    <h2 style="margin-top:10px;">Enrégistrement des évenements et soirées.</h2>
										<hr />
										<p style="font-style:italic;font-size:10px;margin-top:0px;color:red; margin-left:100px; ">(Remplissez le formulaire suivant pour enrégistrer les évenements.)</p>
											<!-- Debut contenu -->
