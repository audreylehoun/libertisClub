...
<header class="section-headerr" style="text-align:center; margin-top:-20px;">
    ...
    if ($_GET["stmsg"] == "ok"){
        ?>
    <script>alert('Votre message a été bien transmis. Nous ne tardons pas généralement à répondre.')</script>
        
        <?php }
        
        if ($_GET["stmsg"] == "no"){
        ?>
    <script>alert('Votre message n\'a pas été transmis. Veuillez réessayer.')</script>
    ...
    <section id="_tjobers" class="lightgrey-bg" style="background:white;">
            ...
            <div class="container-fluid">
                    ...
                    <h3 style="margin-top:-5px; padding:5px;color:#337AB7;"><strong>Laisser nous votre message</strong></h3>
                ...
                <form action="envoimessagecontact.php" method="post">  
...
<!--  FIN DES DIV DEMANDER UN DEVIS ET ETRE CONTACTE ET PLAINTE -->                 <!--  Mis pour les le btoutons d'envoi de plintes -->
                ...
                <div class="b0 address" style="margin-left: 50px;">
                    ...
                    <div id="block-block-13" class="block block-block btnFormStyle">
                        ...
                        <div class="content" style="border-radius: 26px;width:270px; height:50px;">
                            <a style="display: block;  font-size: 2em; padding:1px;" href="formuleruneplainte.php"><h3 class="goodCenterWrite">Formuler une Plainte</h3></a>
                        </div>
