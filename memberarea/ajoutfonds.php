...
LIGAN O. F. Patrick ( +229 67 44 62 18)
 ...
 -->
    ...
    <meta charset="utf-8" />
    <title>Notification d'ajout de fonds | LIBERTIS CLUB</title>
                    ...
                    <div class="club-content-layout-row">
                        ...
                        <div class="club-layout-cell club-content">
							<article class="club-post club-article">
                               ...
                               <!-- Mon code Inserer A SUPRIMER -->
                                
                                <div class="baniere-test">
                                      <div class="baniere-test-Image">
                                        <img src="images1.jpg" alt="Images1"/>
                                            <img class="imageSet" src="images2.png" alt="Images2"/>
                                            <img src="images3.jpg" alt="Images3"/>
                                       </div>
                                
                                 <div class="baniere-test-lesOptions">
                                      
                                       <!--   <img src="images2.png" alt="Images2"/> -->
                                                                        
                                    </div>
                                
                                
                                     <div class="baniere-test-LesContenus">
											...
											<div class="club-layout-cell layout-item-0" style="width: 66%;" >
												...
												<?php
													...
													if(isset($_POST["envoyer"]))
													{
														...
														$objet = "Approvisionnement de compte d'un montant de ".$_POST["montantappro"]." F CFA";
														
														$message = "Moyen de paiement : ".$_POST["moyenpaiement"]."<br /><br />";
														$message.= "Date de paiement : ".$_POST["dateoperation"]."<br /><br />";
														$message.= "Références de paiement : ".$_POST["referencepaiement"]."<br /><br />";
														$message.= $_POST["contenumessage"];
														...
														$req->execute(array($objet, $message, $_SESSION["pseudousers"], $libertis ));
									
														if($req)
														{		
															?>
																<div class='club-succes'>Notification bien enrégistrée. </div><br /><br />
															<?php
														}
														else
														{
															?>
																<div class='club-echec'>L'enrégistrement de la notification a échoué. </div><br /><br />
															<?php
														}
													}
									
												?>
													<h3>Approvisionnement de compte</h3><hr />
													...
													<form style="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
														...
														<input type="number" step="1000" name="montantappro" min="10000" id="montantappro" />
														<br /><br />
														
														<label for="moyenpaiement" class="form_col">Moyen de paiement : </label>
														<select name="moyenpaiement" id="moyenpaiement" required>
															<option value="Virement">Virement</option>
															<option value="Versement">Versement</option>
															<option value="Mobile money">Mobile money</option>
															<option value="Flooz">Flooz</option>
															<option value="Carte bancaire UBA">Carte bancaire UBA</option>
														</select>
														<br /><br />
														
														<label class="form_col" for="dateoperation"> Date de l'opération : </label>
														<input type="date" name="dateoperation" id="dateoperation" />
														<br /><br />
														
														<label class="form_col" for="referencepaiement"><span style="font-size:14px;"> Références : </span></label>
														<textarea id="referencepaiement" name="referencepaiement" rows="5" cols="30" style="font-style:italic;" required >Vos références de paiement</textarea><br /><br />
														
														<label class="form_col" for="contenumessage"><span style="font-size:14px;"> Notifications : </span></label>
														<textarea id="contenumessage" name="contenumessage" rows="10" cols="30" style="font-style:italic;" required >Décrivez votre notification ici</textarea><br /><br />
														
														<label class="form_col"> </label>
														<input type="submit" name="envoyer" value="Notifier maintenant" class="club-button" />
													</form>
