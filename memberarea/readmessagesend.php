										...
										<div class="club-content-layout-row">
											...
											<div class="club-layout-cell layout-item-0" style="width: 66%;" >
												...
												<div>
														...
														{
																$req = $bdd->query('SELECT idmessages,titremessage,naturemessage,destinatairemessage,contenumessage,DATE_FORMAT(datemessages, "%d/%m/%Y à %Hh%imin") AS datemessagesfr FROM messages WHERE idmessages = "'.$_GET["idmessage"].'" ');
																while($donnees = $req->fetch())
																{
																
														?>
																	<h3>Message envoyé à <?php echo $donnees["destinatairemessage"];?></h3><hr /><br />
