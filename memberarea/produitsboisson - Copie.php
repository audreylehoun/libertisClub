        ...
        <?php
            ...
            <div class="col-md-3 col-sm-6">
                            <div class="allo-category-box">
                                <a href="http://31.207.34.150:3006/annuaire-des-entreprises/automobile-moto">
                                    <picture>
                                        <img src="annuaire-des-entreprises_fichiers/categorie_automobile.jpg" alt="">
                                    </picture>
                                </a>
                                <div class="allo-box-caption">
                                    <h3 class="text-center allo-box-caption-title">
                                        <a href="http://31.207.34.150:3006/annuaire-des-entreprises/automobile-moto">Automobile / Moto</a>
                                    </h3>
                                    <p>Les entreprises du secteur automobile : vente de voitures et motos, auto-écoles, stations de lava...</p>
