...
<html lang="fr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="keywords" content="libertis, soirée, réjouissance, libertis benin, lucratif">
...
<!-- Fin entête -->
    ...
    <div class="container" style="margin-top:-28px;">
        <div class="intro-text" >
            <div class="intro-lead-in text-uppercase" style="margin-top:-200px; color:white;" id="testbienvenue">Bienvenue sur le site de LIBERTIS CLUB
</div>
            <br/> 
...
<!-- Portfolio Grid -->
<section style="background-color: white" class="page-section" id="qsn" style="margin-top:-55px !important;">
    <div class="container">
        <div>
