												...
												<?php
													if($_SESSION["codetransaction"] != "0000")
													{
														...
														<tr style="width: 100%; visibility: hidden;">
															<td style="padding:15px;text-align:center; style="width: 100%; visibility: hidden;"">
															<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
														...
														?><br /><br />
															<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
																...
																<span style="font-size:15px;">Montant Total : <span> <span style="font-size:22px;color:green;"><?php echo 'Montant Total ' . $montanttotal;?></span> F CFA
																<br /><br />
