            ...
            <div class="col-md-6 col-offset-2" style="
                ...
                <div class="row content-row" style="margin-top:-70px;">
                            ...
                            <div class="allo-category-box">
                                <a href="produitsboissonsnew.php?catpro=Boisson&pro=boi">
                                    <picture>
                                ...
                                <div class="allo-box-caption">
                                    <h3 class="text-center allo-box-caption-title">
                                        <a href="produitsboissonsnew.php?catpro=Boisson&pro=boi">Boisson</a>
                                    </h3>
                            ...
                            <div class="allo-category-box">
                                ...
                                <div class="allo-box-caption">
                                    ...
                                    <p>Retrouvez dans cet espace vos meilleurs et préférés plats.</p>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-lg-3">
                            <div class="allo-category-box">
                                <a href="produitspartenaire.php?tranage=tout&pro=part">
                                    <picture>
                                        <img src="images/massageok.jpg" alt="">
                                    </picture>
                                </a>
                                <div class="allo-box-caption">
                                    <h3 class="text-center allo-box-caption-title">
                                        <a href="produitspartenaire.php?tranage=tout&pro=part">Extra</a>
                                    </h3>
