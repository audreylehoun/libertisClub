...
LIGAN O. F. Patrick ( +229 67 44 62 18)
 ...
 -->
    ...
    <meta charset="utf-8" />
    <title>Envoyer un fichier | LIBERTIS CLUB</title>
									...
									<div class="club-content-layout">
										<div class="club-content-layout-row">
											...
											<div class="club-layout-cell layout-item-0" style="width: 66%;" >
												...
												<!-- Soumettre fichier -->
												<h3>Soumission de fichier </h3><hr /><br />
													<?php
													if(isset($_POST["terminelibertisinscrir"]))
													{
														if(($_FILES["fichfile"]["name"][0] != "") AND ($_FILES["fichfile"]["name"][1] != ""))
														{
															...
															{		
																...
																{
																	$inscrit = true;
																	$mess = "<div class='club-succes'>Vos fichiers ont bien été soumis.</div>";
																}
																else
																{
																	$inscrit = false;
																	$mess = "<div class='club-echec'>La soumission de vos fichiers a échoué, veuillez réessayer. </div>";	   
																}
													...
													<form id="myForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" id="contact_form" autocomplete="on"> 
															...
															<label class="form_col">Copie de la pièce d'identité : </label>
															<input type="hidden" name="MAX_FILE_SIZE" value="30000000" />
															<input type="file" name="fichfile[]" required /> 		
															<br /> <br />
															
															<label class="form_col">Copie du test VIH : </label>
															<input type="hidden" name="MAX_FILE_SIZE" value="30000000" />
															<input type="file" name="fichfile[]" required /> 		
															<br /> <br />
															
															<label class="form_col"> </label>
															<input type="submit" class="club-button" name="terminelibertisinscrir" value="Soumettre" /> 
													</form>
												<!-- Fin Soumettre fichier -->
