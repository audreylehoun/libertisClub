...
LIGAN O. F. Patrick ( +229 67 44 62 18)
 ...
 -->
    ...
    <meta charset="utf-8" />
    <title>Signaler un abus | LIBERTIS CLUB</title>
									...
									<div class="club-content-layout">
										<div class="club-content-layout-row">
											...
											<div class="club-layout-cell layout-item-0" style="width: 66%;" >
												...
												?>
													<h3>Signaler un abus</h3><hr />
													<p style="font-style:italic;font-size:11px;margin-top:-5px;">Remplissez le formulaire suivant pour signaler un abus</p><br />
													
													<form style="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
													
														<label class="form_col" for="contenumessage"><span style="font-size:14px;"> </span></label>
														<textarea id="contenumessage" name="contenumessage" rows="10" cols="60" style="font-style:italic;" required >Décrivez brièvement l'abus</textarea><br /><br />
														
														<label class="form_col"> </label>
														<input type="submit" name="envoyer" value="Signaler l'abus" class="club-button" />
													</form>
