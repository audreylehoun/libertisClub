...
LIGAN O. F. Patrick ( +229 67 44 62 18)
 ...
 -->
    ...
    <meta charset="utf-8" />
    <title>Boutique | LIBERTIS CLUB</title>
...
<div class="allo-breadcrumb">
            ...
            <div class="row content-row" style="margin-top:-70px;">
                                            <div class="col-md-4 col-sm-6 col-lg-4 col-md-offset-2">
                                 <a href="produitevenement.php">

                                                <div class="allo-category-box" style="height:450px;">
                                <a href="produitevenement.php">
                                    <picture>
                                        <img src="images/evenement.PNG" alt="">
                                    </picture>
                                </a>
                               
                                <div class="allo-box-caption">
                                    <h3 class="text-center allo-box-caption-title">
                                        <a href="produitevenement.php">EVENEMENTS
                                            
                                            </a>
                                        </h3>
                                    <a href="produitevenement.php" id="details"> <p>Participer à des évenements de réjouissances

Réservez votre place pour des sublimes soirèes organisées en compagnies des partenaires de votre choix</p></a>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-lg-4 col-md-offset-1">
                            <div class="allo-category-box" style="height:450px;">
                                <a href="menuproduitsetservice.php">
                                    <picture>

                                        <img src="images/produitserviceHoriz.jpg" alt="">
                                    </picture>
                                </a>
                                <div class="allo-box-caption">
                                    <h3 class="text-center allo-box-caption-title">
                                        <a href="menuproduitsetservice.php">PRODUITS &amp SERVICES</a>
                                    </h3>
 <a href="menuproduitsetservice.php" id="details"> <p>Procurez vous tous les produits pour votre consommation :
Boissons, repas, et autres ....</p></a>
