...
LIGAN O. F. Patrick ( +229 67 44 62 18)
 ...
 -->
    ...
    <meta charset="utf-8" />
    <title>Faire une réclamation | LIBERTIS CLUB</title>
											...
											<div class="club-layout-cell layout-item-0" style="width: 66%;" >
												...
												<?php
													...
													if(isset($_POST["envoyer"]))
													{
														...
														$req->execute(array($objet, $_POST["contenumessage"], $_SESSION["pseudousers"], $libertis ));
									
														if($req)
														{		
															?>
																<div class='club-succes'>Réclamation bien prise en compte. </div><br /><br />
															<?php
														}
														else
														{
															?>
																<div class='club-echec'>Votre réclamation n'a pas été prise en compte veuillez réessayer SVP. </div><br /><br />
															<?php
														}
													}
									
												?>
													<h3>Faire une réclamation</h3><hr />
													<p style="font-style:italic;font-size:11px;margin-top:-5px;">Remplissez le formulaire suivant pour faire une réclamation</p><br />
													
													<form style="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
													
														<label class="form_col" for="contenumessage"><span style="font-size:14px;"> Objet : </span></label>
														<input id="titremessage" type="text" name="titremessage" placeholder="Objet de la réclamation" required /><br /><br />

														<label class="form_col" for="contenumessage"><span style="font-size:14px;">Description :  </span></label>
														<textarea id="contenumessage" name="contenumessage" rows="10" cols="40" style="font-style:italic;" required >Décrivez la réclamation</textarea><br /><br />
														
														<label class="form_col"> </label>
														<input type="submit" name="envoyer" value="Reclamer maintenant" class="club-button" />
													</form>
