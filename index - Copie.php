    ...
    <div class="container" >
        ...
        <div class="row col-lg-12">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto" id="lemenu">
...
<header class="masthead" style="background-image:url(libertis.jpg);
    ...
    <div class="container" style="margin-top:-20px;">
        <div class="intro-text">
            <div class="intro-lead-in text-uppercase">Bienvenue sur le site de LIBERTIS CLUB
</div>
            <br/> 
            ...
            <h4 class="text-uppercase" style="font-size: 1em;">
...
<?php }}else{ ?>
       ...
       <a href="seconnecter/" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" style="background-color:blue; border-radius:10px;">Se connecter</a>
            
            <a href="seconnecter/inscription.php" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" style="background-color:blue;border-radius:10px">S'inscrire</a>
