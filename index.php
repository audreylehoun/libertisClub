<!DOCTYPE html>
<!-- saved from url=(0032)https://reportiah.com/index.php/ -->
<html lang="fr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="Woumiah Tech">
    <meta name="description" content="Reportiah est une plateforme de gestion intégrée de gestion du contact entre les établissements et les parents d&#39;élève.">
    <meta name="keywords" content="école, collège, établissement, complexe scolaire, SMS">
    <link rel="apple-touch-icon" href="memberarea/images/logo.png">
    <link rel="shortcut icon" type="image/x-icon" href="memberarea/images/logo.png">

    <title>Acceuil - LIBERTIS CLUB</title>

    <!-- Bootstrap core CSS -->
    <link href="./Reportiah_files/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="./Reportiah_files/all.min.css" rel="stylesheet" type="text/css">
    <link href="./Reportiah_files/css" rel="stylesheet" type="text/css">
    <link href="./Reportiah_files/css(1)" rel="stylesheet" type="text/css">
    <link href="./Reportiah_files/css(2)" rel="stylesheet" type="text/css">
    <link href="./Reportiah_files/css(3)" rel="stylesheet" type="text/css">

    <!-- Custom styles for this template -->
    <link href="./Reportiah_files/agency.css" rel="stylesheet">
<style>
    #logo{
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container" >
        <!--div class="row text-left">
            <h6 class="font-weight-bold f-16">Appellez nous pour tout renseignement</h6>
            <h6 class="font-weight-bold f-16">+(229) 91 41 22 22 / 98 12 87 87</h6>
        </div-->
        <div class="row col-lg-12">
            <a class="navbar-brand js-scroll-trigger" href="#" id="logo">
                <img src="./Reportiah_files/logo-only.jpg" class="logo-light" alt="" height="40">
                <!--img src="images/logo-dark.png" class="logo-dark" alt="" height="40"-->
                LIBERTIS CLUB</a>
            <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" style="display:none;">
                Menu
...
if ($_GET["cnt"] == "ok"){
    ?>
                 ...
                 <a href="memberarea/menuproduitsetservice.php"><button type="button" class="btn btn-outline-info" style="border-color:white; color:white;">Mon Compte</button></a>
<?php }}else{ ?>
           
            <a href="seconnecter/"><button type="button" class="btn btn-outline-info" style="border-color:white; color:white;">Se Connecter</button></a>
            <a href="seconnecter/inscription.php"><button type="button" class="btn btn-outline-info" style="border-color:white; color:white;">S'inscrire</button></a>     
       ...
       <?php } ?> 
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto" id="lemenu" style="display:none;">
                   
                    <li class="nav-item">
                        <a  class="nav-link js-scroll-trigger" href="#qsn"> Qui sommes -nous ?</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#nosvaleurs">Nos valeurs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#politiqueetsecurite">Sécurité &amp Confidentialité</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#reglement">Reglement intérieur</a>
                    </li>
                </ul>
            </div>
        </div>
...
<header class="masthead" style="background-image:url(libertis.jpg);
	height:355px;">
    <div class="container" style="margin-top:-40px;">
        <div class="intro-text" >
            <div class="intro-lead-in text-uppercase" style="margin-top:-60px;" id="testbienvenue">Bienvenue sur le site de LIBERTIS CLUB
</div>
            <br/> 
            <!--div class="intro-heading text-uppercase">Informer les parents en temps réel...,Permettre aux écoles et universités de diffuser des informations,Contribuer à l’amélioration de l’enseignement.</div-->
            <h4 class="text-uppercase" style="font-size: 1em; display:none;">
Regroupement à but culturel, le Club LIBERTIS est une association à but non lucratif, apolitique qui propose des activités culturelles et conviviales pour favoriser les échanges culturels et les liens d'amitiés et de fraternité entre les personnes de diverses origines.
            
                <br/> <br/>
            </h4>
             <br/><br/>
            <!--a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="https://reportiah.com/login">Se connecter</a-->
                            <!--a href="https://reportiah.com/user/register" class="btn btn-danger">S'inscrire</a-->
                
            <?php 
            if(isset($_GET["cnt"])){
if ($_GET["cnt"] == "ok"){
    ?>
<a href="memberarea/menuproduitsetservice.php" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" style="background-color:blue;border-radius:10px">Mon Compte</a>

<?php }}else{ ?>
           
       <a href="seconnecter/" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" style="background-color:blue; border-radius:10px; display:none;">Se connecter</a>
            
            <a href="seconnecter/inscription.php" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" style="background-color:blue;border-radius:10px;display:none;">S'inscrire</a>
...
<!-- Portfolio Grid -->
<section style="background-color: white" class="page-section" id="qsn">
    <div class="container">
        <div>
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Qui sommes -nous ?</h2>
                <h3 class="section-subheading text-muted"> Le Club LIBERTIS est  :</h3>
            </div>
        </div>
        <div class="row">
            <ul>
                <li class="text-muted">
                    Est une association à but non lucratif, apolitique qui propose des activités culturelles et conviviales pour favoriser les échanges culturels et les liens d'amitiés et de fraternité entre les personnes de diverses origines.
                ...
                <li class="text-muted">
                   Le Club LIBERTIS propose chaque mois un programme de sorties et d'activités variées : ateliers d'échanges, excursions, visites de quartiers, de monuments de musées, expositions et spectacles, soirées.
                    <br><br>
                </li>
                <li class="text-muted">
                  Le Club se veut un lieu privilégié d’échange et de partage, d’ouverture d’esprit et d’acceptation de l’autre.
                    <br><br>
                </li>
                <li class="text-muted">
                     Le Club LIBERTIS propose chaque mois un programme de sorties et d'activités variées : ateliers d'échanges, excursions, visites de quartiers, de monuments de musées, expositions et spectacles, soirées.
    ...
    <!-- Nos Valeurs -->
<section style="background-color: #01A2FA" class="page-section" id="nosvaleurs">
    <div class="container">
        <div>
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Nos valeurs </h2>
                <h3 class="section-subheading text-muted"> Les valeurs de Libertis CLUB
  :</h3>
            </div>
        </div>
        <div class="row">
     ...
     <!-- Reglement interieur -->
<section style="background-color: white" class="page-section" id="reglement">
    <div class="container">
        <div>
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Reglement interieur </h2>
     ...
     <!-- Sécurité &amp Conformité -->

<section style="background-color: #01A2FA!important;" class="bg-light page-section" id="politiqueetsecurite" >
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Sécurité &amp Confidentialité</h2>
        ...
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="service-heading">Politiques de confidentialité	</h4>
                <p class="text-muted"> L’adhésion au club et/participation ne  confère aucun droit de propriété sur le club à un membre ou un adhérent. Le  club reste et demeure la propriété de ses membres fondateurs ... </p>
            
          <button type="button" class="btn btn-primary btn-xs text-uppercase js-scroll-trigger" data-toggle="modal" data-target="" style="background-color:blue;">Voir plus</button>
            
            </div>
            <div class="col-md-4">
          
                <h4 class="service-heading">Gestion des cookies</h4>
                <br/>
                <p class="text-muted">A L’adhésion au club et/participation ne  confère aucun droit de propriété sur le club à un membre ou un adhérent. Le  club reste et demeure la propriété de ses membres fondateurs ...</p>
           <button type="button" class="btn btn-primary btn-xs text-uppercase js-scroll-trigger" data-toggle="modal" data-target="" style="background-color:blue;">Voir plus</button>
            </div>
            <div class="col-md-4">
          
                <h4 class="service-heading">Traitement des DP</h4>
                 <br/>
                <p class="text-muted"> L’adhésion au club et/participation ne  confère aucun droit de propriété sur le club à un membre ou un adhérent. Le  club reste et demeure la propriété de ses membres fondateurs...</p>
           <button type="button" class="btn btn-primary btn-xs text-uppercase js-scroll-trigger" data-toggle="modal" data-target="" style="background-color:blue;">Voir plus</button>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12" style="text-align:center;">
                <span class="copyright"><strong>Copyright © 2015 - <?php echo date("Y");?>. Tous droits réservés.</strong></span>
            
            </div>
            <div class="col-md-8 col-ofset-4">
...
<script src="./Reportiah_files/jquery.min.js.téléchargement"></script>
<script src="./Reportiah_files/bootstrap.bundle.min.js.téléchargement"></script>

<!-- Plugin JavaScript -->
<script src="./Reportiah_files/jquery.easing.min.js.téléchargement"></script>

<!-- Contact form JavaScript -->
<!--script src="https://reportiah.com/assets/web/js/jqBootstrapValidation.js"></script>
<script src="https://reportiah.com/assets/web/js/contact_me.js"></script>

<!-- Custom scripts for this template -->
<script src="./Reportiah_files/agency.min.js.téléchargement"></script>
<!-- Own JS -->
<script type="text/javascript">
    var _url='https://reportiah.com/';
</script>
